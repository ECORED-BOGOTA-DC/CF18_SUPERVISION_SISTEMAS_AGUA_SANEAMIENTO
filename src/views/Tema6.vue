...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-start.mb-5
      .col-auto.BGRS08.px-5.py-3(data-aos="fade-right")
        .h4.text-white.mb-0 Incineración con recuperación de energía
    ...
    #t_6_2.titulo-segundo.color-acento-botones(data-aos="fade-right")
      h2 6.2 Aprovechamiento de residuos de envases de vidrio

    .row.justify-content-center.align-items-end.mb-5
      .col-lg-8.order-lg-1.order-2
        p De acuerdo con la GTC 53-3 (1998), para la optimización de envases de vidrio, se debe tener especial cuidado en que este no contenga material orgánico como papel, madera, cartón, tampoco debe tener materiales inorgánicos tales como la cerámica, porcelana, piedra, escombros, ni se acepta tampoco materiales ferrosos como tapas, tuercas o tornillos ni no ferrosos como aluminio, estaño o plomo, el vidrio debe estar totalmente libre de cualquiera de estos materiales en la etapa de aprovechamiento.
    ...
    #t_6_3.titulo-segundo.color-acento-botones(data-aos="fade-right")
      h2 6.3 Aprovechamiento de residuos de papel y cartón
    ...
    #t_6_4.titulo-segundo.color-acento-botones(data-aos="fade-right")
      h2 6.4 Aprovechamiento de residuos metálicos

    p.mb-5 Para lograr un mejor aprovechamiento de los residuos metálicos se debe hacer una correcta separación entre los que son ferrosos y los que son no ferrosos de acuerdo con la GTC 53-5 (1999).
    ...
    <br><br>
    p De no ser posible el aprovechamiento mecánico se procede a realizar el aprovechamiento térmico, el cual a partir de la ausencia de oxígeno eleva la temperatura en hornos siderúrgicos principalmente hasta que cambien de estado los metales que previamente fueron separados, una vez cambia de estado se agrega el metal líquido en un nuevo molde para obtener otro producto útil.

    separador
    #t_6_5.titulo-segundo.color-acento-botones(data-aos="fade-right")
      h2 6.5 Aprovechamiento de residuos sólidos orgánicos
    ...
    .row.justify-content-start.mb-5
      .col-auto.BGRS08.px-5.py-3(data-aos="fade-right")
        .h4.text-white.mb-0 Métodos biológicos
    
    p.mb-5 Son todos los métodos de aprovechamiento que utilizan seres vivos para hacer una degradación de la materia orgánica en productos de valor agregado como son:

    ul.lista-ul--color.mb-5(data-aos="fade-right")
      li
        i.fas.fa-star-half-alt.fa-spin(style="color: #115089")
        .h4.mb-0 Lombricultura
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-8(data-aos="fade-left")
        ...
        .cajon.color-acento-botones.p-4
          p.mb-0 Esta técnica es muy utilizada en la degradación de residuos sólidos orgánicos ya que no solo soluciona la problemática asociada a dichos residuos, sino que se obtiene el vermiabono como producto, adicional a los ingresos que se obtienen por la venta de la lombriz roja californiana ya que es apta para el consumo humano, o el uso de las mismas para alimentación de animales, fabricación de harina y otros productos alimenticios.

    p.mb-5 Para realizar correctamente la lombricultura se deben tener en cuenta las siguientes etapas:
        ...
        .tarjetas-small(@mouseover="mostrarIndicador = false")
          ...
          .tarjetas-small_card.tarjeta.color-acento-contenido.p-xxl-4.p-xl-3.p-4
            .title.d-flex.align-items-center.justify-content-center.text-white.mb-4
              ...
              h4.text-center.mb-0 Acondicionamiento
            p.text-white.text-center.text-small.mb-0 Se ubican los residuos sólidos orgánicos en un terreno con buen drenaje, procurando voltearlos periódicamente hasta que se estabilicen, luego se introducen los residuos a un contenedor donde se incorporan las lombrices.
          ...
          .tarjetas-small_card.tarjeta.color-primario.p-xxl-4.p-xl-3.p-4
            .title.d-flex.align-items-center.justify-content-center.text-white.mb-4
              span
                i.fas.fa-caret-up.fa-2x.me-3
                i.fas.fa-caret-down.fa-2x.me-3
              h4.text-center.mb-0 Riego y adición de residuos
            p.text-white.text-center.text-small.mb-0 La humedad es un factor clave para la reproducción y crecimiento de las lombrices por lo que se debe regar con agua dos veces por semana, así como añadir residuos nuevos para que estas puedan alimentarse.
      .col-xl-3.col-md-6.col-sm-10.mb-xl-0.mb-4(data-aos="flip-up")
        .tarjetas-small(@mouseover="mostrarIndicador = false")
          .indicador--hover(v-if="mostrarIndicador")
          ...
          .tarjetas-small_card.tarjeta.color-acento-contenido.p-xxl-4.p-xl-3.p-4
            .title.d-flex.align-items-center.justify-content-center.text-white.mb-4
              span
                i.fas.fa-caret-up.fa-2x.me-3
                i.fas.fa-caret-down.fa-2x.me-3
              h4.text-center.mb-0 Periodo de humificación
            p.text-white.text-center.text-small.mb-0 El vermiabono se puede obtener en un periodo de 6 meses; sin embargo, desde el tercer mes se puede utilizar el subproducto generado en diferentes cultivos menores.
          ...
          .tarjetas-small_card.tarjeta.color-primario.p-xxl-4.p-xl-3.p-4
            .title.d-flex.align-items-center.justify-content-center.text-white.mb-4
              span
                i.fas.fa-caret-up.fa-2x.me-3
                i.fas.fa-caret-down.fa-2x.me-3
              h4.text-center.mb-0 Cosecha de lombrices y abono
            p.text-white.text-center.text-small.mb-0 Las lombrices duplican su población en promedio cada tres meses por lo que se deben ir retirando para evitar la sobrepoblación y disminución de alimento, así como se debe ir retirando el vermiabono para permitir la movilización de las lombrices.
      ...
      SlyderA(tipo="b" data-aos="zoom-in")
        .row.justify-content-around
          .col-lg-6.order-lg-1.order-2
            .h4.mt-5 Acondicionamiento materias primas
    ...
    .row.justify-content-start.mb-5
      .col-auto.BGRS08.px-5.py-3(data-aos="fade-right")
        .h4.text-white.mb-0 Procesos termoquímicos
    
    p.mb-5 En este tipo de procesos se mezclan dos principios los cuales son la descomposición de la materia orgánica en moléculas más pequeñas y el uso del calor para lograr dicha descomposición, entre los procesos más relevantes se encuentran:

    ul.lista-ul--color.mb-5(data-aos="fade-right")
      li
        i.fas.fa-star-half-alt.fa-spin(style="color: #115089")
        .h4.mb-0 Combustión para la generación de energía
    
    p.mb-5 En este proceso se queman los residuos sólidos orgánicos en una caldera para producir vapor a alta presión, que posteriormente se utiliza para generar electricidad. Hay dos sistemas para hacer la quema de residuos que son:
      ...
      .col-lg-8(data-aos="fade-left")
        ul.lista-ul--color.lista-ul--separador.mb-5
          li(style="margin-bottom: 2px")
            ...
            p.mb-0 #[strong De parrilla], donde los residuos se queman sobre una rejilla, tienen movimiento y permite la remoción de ceniza.
          li(style="margin-bottom: 2px")
            i.fas.fa-check-double(style="color: #4DB1F0;")
            p.mb-0 #[strong Sistema de lecho fluidizado], donde los residuos arden en un lecho de arena u otro mineral agitado fuerte por el aire de combustión, en este sistema los residuos son alimentados a tasas controladas para mantener una temperatura entre 800 y 900 °C.
        .cajon.color-acento-botones.p-4
          p.mb-0 En algunas ocasiones los residuos también se pueden quemar en conjunto con combustibles fósiles de plantas existentes para reducir las emisiones de contaminantes al aire.

    ul.lista-ul--color.mb-5(data-aos="fade-right")
      li
        i.fas.fa-star-half-alt.fa-spin(style="color: #115089")
        .h4.mb-0 Gasificación
    ...
    ul.lista-ul--color.mb-5(data-aos="fade-right")
      li
        i.fas.fa-star-half-alt.fa-spin(style="color: #115089")
        .h4.mb-0 Licuefacción

    p Es el proceso mediante el cual a partir de residuos sólidos orgánicos se producen combustibles líquidos. Se puede hacer mediante dos métodos:

    .BGM01.px-md-5.px-4.mt-4.mb-5
      .row.justify-content-center
        .col-lg-6
          .BGR07.p-5.mb-4(data-aos="flip-up")
            .h4.text-center.mb-0 Licuefacción indirecta
          p Es cuando se produce metanol o hidrocarburos, es una fase sucesiva a la gasificación, cuando se realiza este proceso se obtiene un material con un poder calorífico de 500 kcal/kg que se utiliza en la industria automotriz.
          .BGR25.p-5.mb-4(data-aos="flip-up")
            .h4.text-center.mb-0 Licuefacción directa
          p.mb-0 A través de esta técnica se pueden obtener líquidos orgánicos oxigenados como aceites pesados, cuando se realiza este método el poder calorífico del producto oscila entre 7000 y 8000 kcal/kg.
    ...
    .row.justify-content-start.mb-5
      .col-auto.BGRS08.px-5.py-3(data-aos="fade-right")
        .h4.text-white.mb-0 Procesos fisicoquímicos
    
    p.mb-5 Finalmente, cuando se habla de aprovechamiento fisicoquímico a los residuos sólidos se combinan técnicas de cambios en presión o temperatura con adición de productos químicos e incluso en algunos casos de enzimas específicas para la obtención de un producto. Dentro de las principales formas de aprovechamiento de residuos orgánicos a partir de procesos fisicoquímicos se encuentra:

    ul.lista-ul--color.mb-5(data-aos="fade-right")
      li
        i.fas.fa-star-half-alt.fa-spin(style="color: #115089")
        .h4.mb-0 Fermentación
    ...
    .BG03.p-4.mb-5
      .row.justify-content-center.align-items-center
        ...
        .col(data-aos="fade-left")
          p.mb-0 Es la obtención de etanol a partir de azúcares, almidón y celulosa por la acción de fermentos que reaccionan en presencia del aire, para lograr una cantidad óptima de alcohol se deben utilizar residuos orgánicos azucarados tales como residuos de caña de azúcar o remolacha, esto debido a su naturaleza pueden ser utilizados directamente para el proceso de fermentación.

    .row.justify-content-center.align-items-center.mb-4
      .col-lg-8.order-lg-1.order-2(data-aos="fade-right")
        p Cuando se tienen residuos amiláceos como por ejemplo los cereales se reciben y se les remueven las impurezas que puedan tener, luego pasan a una trituración para disminuir el tamaño de partícula, entran a un proceso conocido como hidrólisis enzimática donde se realiza la fermentación, cuando se obtiene la cantidad de alcohol óptima este se destila para obtener concentraciones mayores que pueden ser utilizados a nivel industrial.
        .cajon.color-acento-botones.p-4
